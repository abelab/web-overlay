/* eslint-disable */
// borrowed from flowcrypt project and modified a bit.
// https://github.com/FlowCrypt/flowcrypt-browser/blob/master/extension/js/common/core/types/openpgp.d.ts.
...
declare namespace openpgp {
    ...
    export function encrypt(
        options: EncryptBinaryOptions
    ): Promise<EncryptBinaryResult>;
    export function encrypt(
        options: EncryptArmorOptions | BaseEncryptOptions
    ): Promise<EncryptArmorResult>;
    ...
    export interface VerifyResultElement {
        keyid: Keyid;
        verified: Promise<boolean>;
        valid?: boolean;
    }

    export interface VerifyCleartextResult {
        data: string | Stream<string> | NodeStream<any>;
        signatures: Array<VerifyResultElement>;
    }
    export interface VerifyBinaryResult {
        data: Uint8Array | Stream<Uint8Array> | NodeStream<any>;
        signatures: Array<VerifyResultElement>;
    }
    export type VerifyResults = VerifyCleartextResult | VerifyBinaryResult;

    export function verify(options: VerifyOptions): Promise<VerifyResults>;
    ...
    */
    ...
    export namespace enums {
        ...
        function read(
            type: typeof compression,
            e: compression
        ): compressionNames | string | any;
        function read(type: typeof hash, e: hash): hashNames | string | any;
        function read(
            type: typeof packet,
            e: packet
        ): packetNames | string | any;
        function read(
            type: typeof publicKey,
            e: publicKey
        ): publicKeyNames | string | any;
        function read(
            type: typeof symmetric,
            e: symmetric
        ): symmetricNames | string | any;
        function read(
            type: typeof keyStatus,
            e: keyStatus
        ): keyStatusNames | string | any;
        function read(
            type: typeof keyFlags,
            e: keyFlags
        ): keyFlagsNames | string | any;
    ...
    export namespace key {
        ...
        class SubKey {
            constructor(
                subKeyPacket: packet.SecretSubkey | packet.PublicSubkey
            );
    ...
    */
        function readArmored(
            armoredText: string | Stream<string>
        ): Promise<Message>;
    ...
    */
    ...
    export namespace stream {
        function readToEnd<T extends Uint8Array | string>(
            input: Stream<T> | T,
            concat?: (list: T[]) => T
        ): Promise<T>;
        // concat
